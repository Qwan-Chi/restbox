...
🌐 **Демо:** https://qwan-chi.github.io/restbox/
...
При старте можно войти через **Google** или **Яндекс** (если заданы `VITE_GOOGLE_CLIENT_ID` / `VITE_YANDEX_CLIENT_ID` — см. `.env.example`) либо нажать **Продолжить как гость**. Если client_id не задан, показывается только гостевой вход. Данные профиля хранятся в localStorage браузера.
